          ...
          {!activeOrder ? (
            <div className="space-y-6">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <h3 className="font-black uppercase text-[10px] text-gray-400 mb-3 flex items-center gap-2 tracking-widest">Active Jobs in Shop ({activeJobs.length})</h3>
      ...
      <div className="bg-red-50 p-6 rounded-3xl border-4 border-black animate-in slide-in-from-top-4">
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
          ...
          <div className="bg-black text-white p-6 rounded-3xl">
            <h3 className="text-xs font-black uppercase tracking-widest text-gray-500 mb-4">Recent Shop Log</h3>
