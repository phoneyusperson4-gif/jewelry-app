...
export function OrderForm({ formData, loading, error, updateField, toggleArray, onSubmit }) {
  ...
  return (
    <div className="space-y-4"> {/* No outer text-white – each component now manages its own text colour */}
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        {/* Stones received – now using inactiveClass for high contrast */}
        <div className="grid grid-cols-2 gap-3">
          <ToggleButton
        ...
        {/* Engraving – already safe (light background, dark text) */}
        <div className="border-2 border-black rounded-xl p-3 bg-gray-100 text-black space-y-2">
        ...
        {/* Checkbox Groups – now with safe defaults (no forced text-black needed) */}
